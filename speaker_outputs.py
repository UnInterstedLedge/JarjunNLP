...
def response_dr_chen(user_input):
    if user_input == 'hi' or user_input == 'hello':
        ...
        return {"text": "This is the best project I 've ever seen, I'm honored to present you with the Nobel Peace Prize. Congratulations!", "audio": url_for('serve_audio', filename="CCongrats.mp3")}
...
def response_sponge_bob(user_input):
    if user_input == 'hi' or user_input == 'hello':
        ...
        return {"text": "I'm doing pretty good, just living the life you know, enjoying the sun, catching the jelly fish and serving up some delicous Krabby-Patties at the Krusty Krab!!", "audio": url_for('serve_audio', filename="SHowYou.mp3")}
        ...
        return {"text": "Uhhh...I don't think I can tell you that. Maybe try applying for the Krusty Krab and maybe you will learn one day!!", "audio": url_for('serve_audio', filename="SHowYou.mp3")}
